                  ...
                  <Card.Content id="cardSection2">
                    ...
                    <Card.Meta>
                      ...
                      <span>
                        ...
                        <Icon
                          name={
                            restaurant.DeliveryOrders == "Y" ? "check" : "close"
                          }
                        ></Icon>
                      </span>
                                ...
                                <Popup
                                  ...
                                  content={
                                    <Table basic="very" celled collapsing>
                                      <Table.Body>
                                        <Table.Row>
                                          <Table.Cell>Mon: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Tues: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Wed: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Thurs: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Fri: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Sat: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                          <Table.Cell>Sun: 11AM-10PM</Table.Cell>
                                        </Table.Row>
                                      </Table.Body>
                                    </Table>
                                  }
                              ...
                              <Card.Description>
                                <Button.Group fluid>
                                  ...
                                  <a href={restaurant.OrderWebsite} id='takeoutBtn'>
                                    <Button basic color="yellow" id="takeoutBtn">
                                      Takeout
                                    </Button>
                                  </a>
                                </Button.Group>
